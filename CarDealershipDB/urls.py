...
urlpatterns = [
    ...
    path("api/", include("CarDealershipDB.api.urls_auth_api")),
    path("api/", include("CarDealershipDB.api.urls_cars_api")),
    path("api/", include("CarDealershipDB.api.urls_person_api")),
    path("api/", include("CarDealershipDB.api.urls_sales_api")),
